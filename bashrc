...
export PATH=$PATH:/usr/local/slugos/armeb/bin
export PATH=$PATH:/usr/local/gnuarm-4.0.2/bin
export PATH=$PATH:/mnt/data/epd/bin

alias vims='vim -S ~/.vim/sessions/session.vim'
alias svim='sudo vim'

alias ack='ack-grep --color --color-filename=RED --color-match=YELLOW'
alias cdu='cd /home/chris/uni'
#alias ]='xdg-open'
...
export PERL5LIB="/home/chris/perl5/lib/perl5/x86_64-linux-gnu-thread-multi:/home/chris/perl5/lib/perl5";
export PATH="$PATH:/home/chris/perl5/bin";
export PATH="$PATH:/usr/local/sml/bin"
#export PATH="/usr/local/lib/cw:$PATH";

# Stop terminal capturing <C-S> and <C-Q>
stty -ixon -ixoff
